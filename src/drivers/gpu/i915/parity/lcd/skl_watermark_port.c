 ...
 *    tgl_compute_dbuf_slices, adlp_compute_dbuf_slices, skl_compute_dbuf_slices, intel_dbuf_slice_size,
 *    skl_ddb_entry_init, mbus_ddb_offset, skl_watermark_ipc_enabled, skl_needs_memory_bw_wa,
 *    intel_get_linetime_us, skl_cursor_allocation, skl_total_relative_data_rate, intel_crtc_dbuf_weights,
 *    skl_wm_check_vblank, skl_wm_latency, skl_wm_method1, skl_wm_method2,
 *    skl_compute_wm_params, skl_compute_plane_wm_params, skl_wm_has_lines, skl_wm_max_lines,
 *    skl_compute_plane_wm, skl_compute_wm_levels, tgl_compute_sagv_wm, skl_compute_transition_wm,
 *    skl_build_plane_wm_single, icl_build_plane_wm, skl_build_plane_wm_uv, skl_build_plane_wm,
 *    skl_max_wm0_lines, skl_max_wm_level_for_vblank, skl_is_vblank_too_short, skl_build_pipe_wm,
 ...
 *    skl_crtc_allocate_ddb, skl_plane_wm_level, skl_plane_trans_wm, skl_write_wm_level,
 *    skl_ddb_entry_write, skl_write_plane_wm, intel_dbuf_mdclk_cdclk_ratio_update, update_mbus_pre_enable,
 *    intel_dbuf_pre_plane_update, intel_dbuf_post_plane_update, xelpdp_is_only_pipe_per_dbuf_bank, intel_mbus_dbox_update,
 *    skl_wm_level_from_reg_val, skl_pipe_wm_get_hw_state, skl_pipe_ddb_get_hw_state, skl_ddb_get_hw_plane_state,
 *    skl_ddb_entry_union, skl_wm_get_hw_state, skl_dbuf_is_misconfigured, skl_wm_sanitize,
 *    skl_wm_get_hw_state_and_sanitize, skl_ddb_entry_init_from_hw, skl_ddb_dbuf_slice_mask, skl_ddb_entries_overlap,
