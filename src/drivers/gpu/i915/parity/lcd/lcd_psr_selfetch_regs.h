 ...
 * by tools/port_lcd_calc.py.  The notice above is the source file's own.  Do not edit by hand.
 */
#ifndef PARITY_LCD_PSR_SELFETCH_REGS_H
#define PARITY_LCD_PSR_SELFETCH_REGS_H
...
#endif /* PARITY_LCD_PSR_SELFETCH_REGS_H */
