...
/*
 * zedBSD WS031: generated from Linux v6.8.12 drivers/gpu/drm/i915/display/intel_modeset_setup.c
 * (sha256 b14fd33c597ffd7271a4dea910ebd71e7b3513d261d54c5706d27f84acb65ee4) by plan/ws031/handover/tools/port_lcd_calc.py.
 * The function bodies are the reference text.  Kept / changed:
 *  - kept: intel_crtc_needs_link_reset, get_bigjoiner_slave_pipes, get_portsync_pipes, get_transcoder_pipes,
 *    intel_crtc_disable_noatomic_begin, intel_crtc_disable_noatomic_complete, intel_crtc_disable_noatomic, set_encoder_for_connector,
 *    reset_encoder_connector_state, reset_crtc_encoder_state, intel_modeset_update_connector_atomic_state, intel_crtc_copy_hw_to_uapi_state,
 *    intel_sanitize_plane_mapping, intel_crtc_has_encoders, intel_encoder_find_connector, intel_sanitize_fifo_underrun_reporting,
 *    has_bogus_dpll_config, intel_sanitize_crtc, intel_sanitize_all_crtcs, intel_sanitize_encoder,
 *    readout_plane_state, intel_modeset_readout_hw_state, get_encoder_power_domains, intel_early_display_was,
 *    intel_modeset_setup_hw_state;
 *  - the includes are replaced by: lcd_compat.h, lcd_ddi_regs.h, lcd_seq_compat.h, lcd_modeset_compat.h, lcd_plane_compat.h, lcd_wm_compat.h, lcd_flip_compat.h, n1_compat.h;
 *  - parity_modeset_setup_glue.inc (zedBSD code) is included at the end of the file.
 */
...
#include "parity_modeset_setup_glue.inc"
