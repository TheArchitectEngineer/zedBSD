...
/*
 * zedBSD WS031: generated from Linux v6.8.12 drivers/gpu/drm/i915/display/intel_dp_aux.c
 * (sha256 f4a5dff0764804bdc7b5a57f79b11d3f10dfa8869f09f0df37f6fa999e777925) by plan/ws031/handover/tools/port_dp_aux_pps.py.
 ...
 *    g4x_dp_aux_precharge_len, g4x_get_aux_send_ctl, vlv_aux_ctl_reg, vlv_aux_data_reg,
 *    g4x_aux_ctl_reg, g4x_aux_data_reg, ilk_aux_ctl_reg, ilk_aux_data_reg,
 *    skl_aux_ctl_reg, skl_aux_data_reg, xelpdp_aux_ctl_reg, xelpdp_aux_data_reg,
 *    aux_ch_name, intel_dp_aux_fini, intel_dp_aux_init, default_aux_ch,
 *    get_encoder_by_aux_ch, intel_dp_aux_ch, intel_dp_aux_irq_handler;
...
#include "dp_compat.h"	/* zedBSD: replaces the drm/i915 includes */
...
#include "parity_dp_aux_glue.inc"	/* zedBSD: object setup */
