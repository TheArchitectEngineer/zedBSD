...
cc -std=c89 -Wall -Wextra -Werror -D_POSIX_C_SOURCE=200809L -Dioctl=sync_test_ioctl -Dpoll=sync_test_poll \
    ...
    "$repo/plan/ws030/tests/libvulkan-notify.c" \
    -pthread -o "$work/notify-test"
timeout 20 "$work/notify-test"
...
cc -std=c89 -Wall -Wextra -Werror -D_POSIX_C_SOURCE=200809L -Dioctl=sync_test_ioctl -Dpoll=sync_test_poll \
    ...
    "$repo/userland/base/libvulkan/query.c" \
    "$repo/plan/ws030/tests/libvulkan-notify.c" \
    -pthread -o "$work/notify-sanitized"
ASAN_OPTIONS=detect_leaks=1 timeout 20 "$work/notify-sanitized"
