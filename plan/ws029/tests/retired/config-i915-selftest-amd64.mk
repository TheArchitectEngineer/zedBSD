# Native i915 GPU configuration with the attach-time selftest; ordinary config.mk is untouched.
...
CONFIG_DRIVER_PCI_I915_SELFTEST := y
# A short execution deadline lets the hang-injection test observe isolation quickly.
CONFIG_GPU_JOB_EXECUTION_MS := 10000
...
# The PC/AT text provider keeps the console; the IGD passthrough guest has no scanout.
CONFIG_DRIVER_GRAPHICS := y
CONFIG_DRIVER_LGY98 := n
ZEDBSD_USER_PROGRAMS := gpu-i915-test cat ls dmesg sleep sync kill rm
