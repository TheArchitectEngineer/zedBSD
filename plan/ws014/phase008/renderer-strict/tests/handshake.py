...
prefix = Path('/home/awe/zedbsd-q306-venus/dependencies/q311-strict/install')
...
cases = [('valid_strict', struct.pack('<IIII', 1, 0, 0x5a424453, 3), struct.pack('<II', 0x5a424453, 3)),
         ('wrong_magic', struct.pack('<IIII', 1, 0, 0x12345678, 3), b''),
         ('old_opaque_only', struct.pack('<IIII', 1, 0, 0x5a424453, 1), b''),
         ('unknown_flags', struct.pack('<IIII', 1, 0, 0x5a424453, 7), b''),
