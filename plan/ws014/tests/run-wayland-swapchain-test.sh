...
flags='-std=c11 -D_GNU_SOURCE -Wall -Wextra -Werror -Wno-missing-field-initializers -Wdeclaration-after-statement -pthread -ffunction-sections -fdata-sections -Wl,--gc-sections'
