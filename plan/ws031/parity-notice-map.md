...
|---|---|---|---|
| `parity/backend.h` | 42 | - | — |
| `parity/backend_delayed.c` | 237 | - | — |
| `parity/backend_delayed.h` | 61 | - | — |
| `parity/backend_dma.c` | 47 | - | — |
| `parity/backend_mmio.c` | 159 | yes | — |
| `parity/backend_pci.c` | 139 | - | — |
| `parity/backend_sync.c` | 286 | - | — |
| `parity/backend_sync.h` | 85 | - | — |
...
| `parity/display_nogem.c` | 1553 | - | `display/intel_gmbus.h`×1, `display/skl_watermark.c`×1, `display/intel_dpll_mgr.c`×1, `display/intel_crtc.c`×1, `display/intel_display_wa.c`×1, `display/intel_cdclk.c`×1 |
| `parity/display_nogem.h` | 368 | - | — |
...
| `parity/dp/dp_compat.h` | 323 | - | `i915_reg_defs.h`×1, `i915_reg.h`×1, `i915_utils.h`×1, `display/intel_display_power.c`×1, `display/intel_pps.h`×1, `display/intel_dp_aux.h`×1 |
| `parity/dp/dp_fake_hw.c` | 481 | - | — |
| `parity/dp/dp_fake_hw.h` | 91 | - | — |
...
| `parity/dp/edp_ktest.c` | 174 | - | — |
| `parity/dp/edp_ktest.h` | 11 | - | — |
| `parity/dp/edp_sync_ktest.c` | 312 | - | — |
...
| `parity/dp/parity_dp_kernel.c` | 590 | - | — |
| `parity/dp/parity_dp_kernel.h` | 89 | - | — |
| `parity/dp/parity_drm_dp_glue.inc` | 15 | - | — |
| `parity/dp/parity_drm_edid_glue.inc` | 54 | - | — |
| `parity/dp/parity_edp.c` | 393 | - | `display/intel_pps_regs.h`×1 |
| `parity/dp/parity_edp.h` | 171 | - | — |
...
| `parity/ktest.c` | 5437 | - | — |
| `parity/ktest.h` | 16 | - | — |
| `parity/lcd/drm_edid_mode_port.c` | 215 | yes | — |
| `parity/lcd/edid_ref_types.h` | 264 | - | — |
| `parity/lcd/intel_dpll_port.c` | 174 | yes | `display/intel_dpll_mgr.c`×1 |
| `parity/lcd/intel_link_port.c` | 235 | yes | `display/intel_dp.c`×2, `display/intel_display.c`×1 |
| `parity/lcd/lcd_compat.h` | 137 | - | — |
| `parity/lcd/lcd_ref_types.h` | 82 | - | `display/intel_display_types.h`×1, `display/intel_dpll_mgr.h`×1, `i915_reg.h`×1 |
| `parity/lcd/parity_dpll_glue.inc` | 35 | - | — |
| `parity/lcd/parity_edid_mode_glue.inc` | 61 | - | — |
| `parity/lcd/parity_lcd_calc.c` | 122 | - | — |
| `parity/lcd/parity_lcd_calc.h` | 60 | - | — |
...
| `parity/power_domains.c` | 1032 | - | `i915_reg.h`×2, `display/intel_display_power.c`×1 |
| `parity/power_domains.h` | 259 | - | — |
| `parity/probe.c` | 2347 | - | — |
| `parity/pte.c` | 45 | - | — |
| `parity/pte.h` | 36 | - | — |
| `parity/pxp.c` | 91 | - | — |
...
|---|---|---|---|
| `i915_reg.h` | 12 | MIT (permission notice text, no SPDX tag) | Copyright 2003 Tungsten Graphics, Inc., Cedar Park, Texas. |
...
| `display/intel_display_types.h` | 3 | MIT (permission notice text, no SPDX tag) | Copyright (c) 2006 Dave Airlie <airlied@linux.ie>; Copyright (c) 2007-2008 Intel Corporation |
...
| `display/intel_dpll_mgr.c` | 2 | MIT (permission notice text, no SPDX tag) | Copyright © 2006-2016 Intel Corporation |
...
| `display/intel_display_power.c` | 2 | MIT | Copyright © 2019 Intel Corporation |
...
| `display/intel_display.c` | 2 | MIT (permission notice text, no SPDX tag) | Copyright © 2006-2007 Intel Corporation |
...
| `display/intel_dp.c` | 1 | MIT (permission notice text, no SPDX tag) | Copyright © 2008 Intel Corporation |
| `display/intel_dpll_mgr.h` | 1 | MIT (permission notice text, no SPDX tag) | Copyright © 2012-2016 Intel Corporation |
...
151 parity files; 53 name at least one upstream file; 29 carry port wording; 73 distinct upstream files named.
