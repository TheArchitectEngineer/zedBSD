# WS031 p013: the model viewer on Venus (Wayland config of WS014 plus USB HID for the tablet).
...
ZEDBSD_USER_PROGRAMS := mview wltest zwl gpu-share-test gpu-fence-test gpu-admission-test gpu-recovery-test vkdemo venus-frame cat ls dmesg sleep sync kill rm
