...
| 生成元 | zedBSD 作業ツリー（HEAD e298eabe + 未コミット差分 = `e97-e105-changes.patch`）、`src/drivers/gpu/i915/parity/eu_test.c` `parity_eu_test_build_batch()` と同ファイルの `eu_marker_cs[]`／IDD 設定 |
