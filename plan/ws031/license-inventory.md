...
|---|---|---|---|---|---|---|---|
| `src/drivers/gpu/i915/draw_fixture.h` | 80 | - | - | 0 | 0 | - | yes |
...
| `src/drivers/gpu/i915/parity/bios.c` | 314 | - | - | 1 | 0 | - | yes |
| `src/drivers/gpu/i915/parity/bios.h` | 62 | - | - | 0 | 0 | - | yes |
...
| `src/drivers/gpu/i915/parity/display_core.c` | 396 | - | - | 1 | 0 | - | yes |
...
| `src/drivers/gpu/i915/parity/eu_test.c` | 1748 | - | - | 0 | 1 | - | yes |
| `src/drivers/gpu/i915/parity/eu_test.h` | 347 | - | - | 2 | 0 | - | yes |
...
| `src/drivers/gpu/i915/parity/ktest.c` | 5185 | - | - | 0 | 0 | - | yes |
...
| `src/drivers/gpu/i915/parity/osdep/firmware.c` | 63 | - | - | 0 | 0 | - | yes |
...
| `src/drivers/gpu/i915/parity/probe.c` | 2323 | - | - | 0 | 0 | - | yes |
...
| `src/drivers/gpu/i915/selftest.c` | 2486 | Zlib | Copyright (C) 2026 Awe Morris | 0 | 3 | - | yes |
| `src/drivers/gpu/i915/tex_fixture_gen.inc` | 96 | MIT | - | 0 | 5 | yes | yes |
| `src/drivers/gpu/i915/uncore.c` | 394 | Zlib | Copyright (C) 2026 Awe Morris | 2 | 0 | - | yes |
| `src/drivers/gpu/i915/vk/cmd.c` | 468 | Zlib | Copyright (C) 2026 Awe Morris | 0 | 0 | - | yes |
...
152 files, 52949 lines. SPDX tag present: 41. Copyright line present: 40. Marked generated: 9.
